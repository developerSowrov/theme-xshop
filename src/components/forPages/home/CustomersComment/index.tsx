   ...
   return (
      <section className="relative my-20 flex flex-col gap-6">
         ...
         <div className="max-xl:hidden">
            <div className="mask-to-l from-white-100/50 absolute left-0 top-10 z-30 h-full w-36 bg-linear-to-r from-light/50 to-transparent backdrop-blur-xl" />
            <div className="mask-to-r from-white-100/50 absolute right-0 top-10 z-30 h-full w-36 bg-linear-to-r from-light/50 to-transparent backdrop-blur-xl" />
         </div>

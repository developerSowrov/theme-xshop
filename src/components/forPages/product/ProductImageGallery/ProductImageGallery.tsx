...
import { CSSProperties, FC, memo, useState, JSX } from "react";
      ...
      <section className="flex flex-col gap-3 xl:w-1/3">
         ...
         >
            {images.map((item, index) => (
               <SwiperSlide
                  key={index}
                  className={`${activeImageIndex === index ? "border-black/20" : "border-transparent"} overflow-hidden rounded-2xl border-[3px]`}
               >

...
const SearchInput = (): JSX.Element => {
   ...
   return (
      <label
         ...
         className={"relative flex w-full rounded-full bg-[#f3f1f1] p-3 transition-all max-xl:shadow-md"}
      >
         ...
         {/* Search Result */}
         <div
            className={`${isOpenSearch ? "scale-y-100" : "scale-y-0"} ${data ? "border p-3 pr-0" : "border-0 p-0"} absolute left-0 top-14 m-0 flex max-h-96 w-full origin-top flex-col items-center justify-center overflow-hidden rounded-20 bg-gray-100 shadow-md transition-all`}
         >
            {isLoading ? (
               <div className="py-9">

            ...
            <>
               ...
               {discount ? (
                  <div className="flex items-center gap-3">
                     {/* Price with Discount */}
                     <del className={`${smallSize ? "text-xl" : textSize} font-bold text-gray-400`}>${price}</del>
                     {/* DISCOUNT */}
                     <span
                        className={`${smallSize ? "text-sm" : "text-base"} rounded-full bg-red-50 px-3 py-1 font-semibold text-red-500`}
                     >
                        -{discount}%
                     </span>
                  </div>
